...
export const Button: React.FC<ButtonProps> = ({text, onClick, icon}) => {
  return (
    <div
      className="relative flex items-center rounded-full p-2 w-[200px] overflow-hidden border border-solid border-gray-400 group text-gray-500 hover:text-white cursor-pointer"
      onClick={onClick}
    >
